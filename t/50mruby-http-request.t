...
EOT
    ...
    run_with_curl($server, sub {
        ...
        subtest "esi" => sub {
            ...
            like $headers, qr{HTTP/[^ ]+ 200\s}is;
            is $body, "Hello to the world, from vhttp!\n";
        };
        subtest "partial" => sub {
...
subtest 'keep-alive (vhttp <=> upstream)' => sub {
...
subtest 'keep-alive (client <=> vhttp)' => sub {
    my $doit = sub {
        my ($path, $chunked) = @_;
