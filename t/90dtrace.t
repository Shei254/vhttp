 ...
 * the datatype declared in vhttp-probes.d. Ignore the upper bits by masking. */
usdt::vhttp:receive_request {printf("*** %llu:%llu version %d.%d ***\n", arg0, arg1, (arg2 & 0xffffffff) / 256, (arg2 & 0xffffffff) % 256)}
usdt::vhttp:receive_request_header {printf("%s: %s\n", str(arg2, arg3), str(arg4, arg5))}
usdt::vhttp:send_response {printf("%llu:%llu status:%u\n", arg0, arg1, arg2)}
usdt::vhttp:send_response_header {printf("%s: %s\n", str(arg2, arg3), str(arg4, arg5))}
/* arg1: uint8_t
 * Same workaround for bpftrace */
usdt::vhttp:h2_unknown_frame_type {printf("Unknown HTTP/2 frame type: %d\n", (arg1 & 0xff))
}
EOT
