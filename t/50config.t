...
EOT
        ...
        subtest 'nonexist' => sub {
            ...
            eval {
                # Dummy port is specified to prevent spawn_vhttp from returning before the configuration error is detected. This can
                # happen because the `listen` directives are specified above the erroneous config line.
                spawn_vhttp({conf => $conf, extra_ports => [empty_port()]});
            };
