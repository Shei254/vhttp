...
# determine upstream port to be used, spawn vhttp that would connect there
...
# spawn upstream psgi, check if it can receive the chunked request and a requset that follows it being forwarded by vhttp
