...
<p>
vhttp is a new generation HTTP server that <b>provides quicker response to users with less CPU, memory bandwidth utilization</b> when compared to older generation of web servers.
...
<div align="center">
<a href="assets/8mbps100msec-nginx195-vhttp150.png" target="_blank"><img src="assets/8mbps100msec-nginx195-vhttp150.png" width="333" height="250"></a>
<a href="assets/staticfile612-nginx1910-vhttp170.png" target="_blank"><img src="assets/staticfile612-nginx1910-vhttp170.png" width="200" height="250"></a>
</div>
...
<li><a href="https://github.com/vhttp/picotls/pull/310" target=_blank>fusion AES-GCM engine</a> for fast QUIC packet generation</li>
</ul>
<li>TCP
<ul>
<li>TCP Fast Open
...
<li><a href="configure/vhttplog.html">BPF-based tracing tool</a> (experimental)</li>
</ul>
