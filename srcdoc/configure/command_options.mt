...
<p>
Full list of command options can be viewed by running <code>vhttp --help</code>.
Following is the output of <code>--help</code> as of version 1.2.0.
</p>

<?= $ctx->{code}->(<< 'EOT')
Options:
  -c, --conf FILE    configuration file (default: vhttp.conf)
...
Please run <code>vhttp --help</code> to find out the location.
</p>
