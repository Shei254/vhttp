...
<p>
Starting from version 1.7, vhttp comes with a mruby script named <a href="https://github.com/vhttp/vhttp/blob/master/share/vhttp/mruby/htpasswd.rb">htpasswd.rb</a> that implements <a href="https://tools.ietf.org/html/rfc2617" target="_blank">Basic Authentication</a>.
...
<p>
In vhttp versions prior to 2.0, you should specify <code>"#{$vhttp_ROOT}/share/vhttp/mruby/htpasswd.rb"</code> as the argument to <code>require</code>, since the directory is not registered as part of <code>$LOAD_PATH</code>.
</p>
